...
«Привет, его имя!». */
var name = prompt('Задание 1. Введите своё имя:');
alert('Привет, ' + name + '!');
// задание 2
...
var year = 2023;
var borned = prompt('Задание 2. Введите дату рождения:');
var old = year - borned;
alert('Вам ' + old);
// задание 3
/* Запросите у пользователя длину стороны квадрата и вы-
ведите периметр такого квадрата. */
var side = prompt('Задание 3. Введите длину стороны квадрата:');
alert('Периметр равен ' + (side * 4));
// задание 4
/* Запросите у пользователя радиус окружности и выведите
площадь такой окружности. */
var radius = prompt('Задание 4. Введите радиус окружности:');
alert('Площадь окружности равна ' + (Math.pow(radius, 2) * 3.14));
// задание 5
...
успеть вовремя. */
var rastoyanie = prompt('Задание 5. Введите растояние между пунктами в километрах:');
var time = prompt('Введите время, за которое расчитываете добраться в часах:');
...
константе. */
var dollars = prompt('Задание 6. Введите сумму в долларах:');
var kursEuro = 0.92;
...
мещается на флешку. */
var fleshka = prompt('Задание 7. Введите объём памяти флешки в Гб:');
...
var sum = prompt('Задание 8. Введите сумму денег в кошельке:');
var chocolate = prompt('Введите стоимость шоколада:');
var ostatok = sum % chocolate;
var sum2 = sum - ostatok;
...
var number = prompt('Задание 9. Введите трёхзначное число:');
var n1 = number % 10;
var n2 = (number % 100 - number % 10) / 10;
var n3 = (number % 1000 - number % 100) / 100;
...
var num = prompt('Задание 10. Введите число:');
